const products = [
    ...
    price: 999.99,
    category: "Laptops",
    image: "Pictures/https://via.placeholder.com/300",
    rating: 4.8,
    stock: 15,
    ...
    //search funcion implementations
    function searchProducts(product, searchTerm) {
    ...
    //function on with name renderProducts and pass array of objects as parameter
